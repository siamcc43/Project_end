        ...
        <Paper sx={{ p: 2 }}>
          <Box display="flex">
            ...
            <Box>
              <Link href="/creatadmin">
                <Button variant="contained">เพิ่มข้อมูลผู้ดูแลระบบ</Button>
              </Link>{" "}
            </Box>
          </Box>
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead>
                <TableRow>
                  <TableCell>รหัสผู้ดูแลระบบ</TableCell>
                  <TableCell align="center">อีเมล</TableCell>

                  <TableCell align="center">ชื่อ</TableCell>
                  <TableCell align="center">สกุล</TableCell>
                  <TableCell align="center">เบอร์โทรศัพท์</TableCell>
                  <TableCell align="center">จัดการข้อมูลผู้ดูแลระบบ</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {items.map((row) => (
